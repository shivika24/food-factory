...
<center><div class="container" style="color:'black';background-image:url('https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT68dnCvEQ2NpaMJ8Zh5vIgExDm862wITzwhUeMMynd7-gaxJUX&usqp=CAU')">
    <a href="loginuser.php"><button id="bid"><b>LOGIN AS CUSTOMER</b></button></a><a href="loginrestaurant.php"><button id="bid"><b>LOGIN AS RESTAURANT</b></button></a>
        ...
        if($insert==true)
        {
            header("refresh: 0; url = http://localhost/food%20factory/home.html");             
        }
        ?>
        ...
        <a href="index.php" style="text-decoration:'none';color:'blue';">Not Yet Registered...?click here.</a>
        </div></center>

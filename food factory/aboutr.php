<?php
    ...
    if(!$con)
    {
     ...
     $sql = mysqli_query($con,"SELECT * FROM restaurants WHERE email='$email'");
         ...
         border: 2px solid black;" data-toggle="collapse" data-target="#navcol-1"><span></span><span></span><span></span></button>
             <div class="collapse navbar-collapse p-4" id="navcol-1">
                 <ul class="nav navbar-nav ml-auto">
                     ...
                     {
                     ?><a class="nav-link" href="logout.php" style="color:'black';"><br>Logout</a>
                     <?php
                     }
                     else
                     {?>
                     <a class="nav-link" href="loginrestaurant.php">Login & SignUp</a>
                     <?php
                     }?>
